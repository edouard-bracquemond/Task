...
public class NotificationHelper extends ContextWrapper {
    ...
    public void createChannels(){
        ...
        channel1.setLightColor(0xFFFF69B4);
        ...
        channel2.setLightColor(0xFFFF69B4);
    ...
    public NotificationCompat.Builder getChannel1Notification(){
        ...
        title = "Attention :";
        message = "La date pour accomplir une tâche est dépassée";
    ...
    public NotificationCompat.Builder getChannel2Notification(){
        String title, message;
        title = "Rappel :";
        message = "La date pour accomplir une tâche va bientôt être dépassée";
